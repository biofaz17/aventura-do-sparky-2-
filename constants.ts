...
// ========================================================================
// SEGURANÇA — AdminPanel
// ========================================================================
/** PIN de 6 dígitos para acessar o painel administrativo via /#/admin */
export const ADMIN_PIN = '031415';
...
export const LEVELS: LevelConfig[] = [
  ...
  },
  {
    id: 37,
    title: "Bifurcação",
    mission: "O caminho se divide. Se houver chão livre para a direita, vá para a direita. Senão, suba.",
    gridSize: 6,
    startPos: { x: 0, y: 5 },
    goalPos: { x: 5, y: 0 },
    obstacles: [{x:1, y:5}, {x:2, y:5}, {x:3, y:5}, {x:4, y:5}, {x:5, y:5}],
    maxBlocks: 10,
    availableBlocks: [BlockType.REPEAT_UNTIL, BlockType.IF_PATH, BlockType.MOVE_RIGHT, BlockType.ELSE, BlockType.MOVE_UP],
    explanation: "Você fez o robô escolher o melhor caminho sozinho!",
    ageGroup: '11-14',
    requiredSubscription: SubscriptionTier.PRO
  },
  {
    id: 38,
    title: "A Escada Condicional",
    mission: "Use um laço de repetição com 'Se Obstáculo' para escalar as caixas.",
    gridSize: 6,
    startPos: { x: 0, y: 0 },
    goalPos: { x: 5, y: 5 },
    obstacles: [{x:1,y:0}, {x:2,y:1}, {x:3,y:2}, {x:4,y:3}],
    maxBlocks: 8,
    availableBlocks: [BlockType.REPEAT_UNTIL, BlockType.MOVE_RIGHT, BlockType.IF_OBSTACLE, BlockType.MOVE_UP],
    explanation: "Isso é um comportamento emergente complexo usando poucas linhas de código.",
    ageGroup: '11-14',
    requiredSubscription: SubscriptionTier.PRO
  },
  {
    id: 39,
    title: "Labirinto Cego I",
    mission: "Você não vê o mapa inteiro, mas a regra é simples: 'Siga a parede'.",
    gridSize: 7,
    startPos: { x: 0, y: 3 },
    goalPos: { x: 6, y: 3 },
    obstacles: [{x:2,y:3}, {x:4,y:3}],
    maxBlocks: 10,
    availableBlocks: [BlockType.REPEAT_UNTIL, BlockType.IF_OBSTACLE, BlockType.MOVE_UP, BlockType.MOVE_DOWN, BlockType.MOVE_RIGHT, BlockType.ELSE],
    explanation: "Algoritmos de 'Wall Follower' ajudam ratos robôs a escapar de labirintos reais.",
    ageGroup: '11-14',
    requiredSubscription: SubscriptionTier.PRO
  },
  {
    id: 40,
    title: "Labirinto Cego II",
    mission: "Uma evolução do último nível. O caminho é mais tortuoso.",
    gridSize: 7,
    startPos: { x: 0, y: 0 },
    goalPos: { x: 6, y: 6 },
    obstacles: [{x:1,y:0}, {x:1,y:1}, {x:1,y:2}, {x:3,y:3}, {x:3,y:4}, {x:5,y:5}, {x:5,y:6}],
    maxBlocks: 12,
    availableBlocks: [BlockType.REPEAT_UNTIL, BlockType.IF_PATH, BlockType.ELSE_IF, BlockType.ELSE, BlockType.MOVE_RIGHT, BlockType.MOVE_DOWN],
    explanation: "Combinações de IF e ELSE IF permitem avaliar múltiplas condições.",
    ageGroup: '11-14',
    requiredSubscription: SubscriptionTier.PRO
  },
  {
    ...
    mission: "Se houver caminho, ande e pinte. Senão, dê a volta.",
    gridSize: 6,
    startPos: { x: 0, y: 2 },
    goalPos: { x: 5, y: 2 },
    obstacles: [{x:2,y:2}, {x:3,y:2}], 
    maxBlocks: 15,
    availableBlocks: [BlockType.REPEAT_UNTIL, BlockType.IF_PATH, BlockType.ELSE, BlockType.MOVE_RIGHT, BlockType.PAINT, BlockType.MOVE_UP, BlockType.MOVE_DOWN],
    explanation: "Agentes inteligentes verificam as condições antes de agir.",
    ageGroup: '11-14',
    requiredSubscription: SubscriptionTier.PRO
  },
  {
    ...
    mission: "Acesse todas as extremidades. O robô deve descer sempre que bater em uma parede.",
    gridSize: 6,
    startPos: { x: 0, y: 0 },
    goalPos: { x: 5, y: 5 },
    obstacles: [{x:1,y:0}, {x:2,y:1}, {x:3,y:2}, {x:4,y:3}],
    maxBlocks: 10,
    availableBlocks: [BlockType.REPEAT_UNTIL, BlockType.MOVE_RIGHT, BlockType.IF_OBSTACLE, BlockType.MOVE_DOWN, BlockType.MOVE_LEFT],
    explanation: "Processamento sequencial em forma de zigue-zague autônomo.",
    ageGroup: '11-14',
    requiredSubscription: SubscriptionTier.PRO
  },
  {
    ...
    mission: "Faça o robô escolher entre subir, descer ou continuar reto.",
    gridSize: 7,
    startPos: { x: 0, y: 3 },
    goalPos: { x: 6, y: 3 },
    obstacles: [{x:1,y:3}, {x:3,y:2}, {x:3,y:3}, {x:5,y:3}, {x:5,y:4}],
    maxBlocks: 15,
    availableBlocks: [BlockType.REPEAT_UNTIL, BlockType.IF_OBSTACLE, BlockType.ELSE_IF, BlockType.ELSE, BlockType.MOVE_RIGHT, BlockType.MOVE_UP, BlockType.MOVE_DOWN],
    explanation: "Sua lógica acaba de subir de nível arquitetural.",
    ageGroup: '11-14',
    requiredSubscription: SubscriptionTier.PRO
  },
  {
    id: 44,
    title: "O Cofre",
    mission: "Evite os alarmes repetindo o padrão lógico adaptativo.",
    gridSize: 7,
    startPos: { x: 0, y: 0 },
    goalPos: { x: 6, y: 6 },
    obstacles: [{x:2,y:2}, {x:4,y:4}, {x:2,y:4}, {x:4,y:2}],
    maxBlocks: 14,
    availableBlocks: [BlockType.REPEAT_UNTIL, BlockType.IF_PATH, BlockType.ELSE, BlockType.MOVE_RIGHT, BlockType.MOVE_DOWN, BlockType.PAINT],
    explanation: "O segredo foi hackeado. Falta pouco para o fim!",
    ageGroup: '11-14',
    requiredSubscription: SubscriptionTier.PRO
  },
  {
